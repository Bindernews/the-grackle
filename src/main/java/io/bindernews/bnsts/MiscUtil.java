...
public class MiscUtil {
    ...
    public static String getPowerId(Class<? extends AbstractPower> clazz) {
        try {
            return (String) clazz.getDeclaredField("POWER_ID").get(null);
        } catch (Exception ignored) {}
        try {
            return (String) clazz.getDeclaredMethod("getPowerId").invoke(null);
        } catch (Exception ignored) {}
        try {
